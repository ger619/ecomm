class Admin::OrdersController < AdminController
  ...
  def index
    @not_fulfilled_pagy, @not_fulfilled = pagy(Order.where(fulfilled: false).order(created_at: :asc))
    @fulfilled_pagy, @fulfilled = pagy(Order.where(fulfilled: true).order(created_at: :asc), page_param: :page_fulfilled)
  end
